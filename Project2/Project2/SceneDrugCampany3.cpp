...
//コンストラクタ
CSceneDrugCampany3::CSceneDrugCampany3()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampany3::InitScene()
{
	...
	Draw::LoadImage(L"製薬会社３階マップ.png", 6, TEX_SIZE_512);
	...
	//製薬会社オブジェクト作成
	CObjDrugCampany3* objd = new CObjDrugCampany3(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY3, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampany3::Scene()
{
}