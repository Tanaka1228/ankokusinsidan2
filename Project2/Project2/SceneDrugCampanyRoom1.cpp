...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom1::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom1* objd = new CObjDrugCampanyRoom1(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM1, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom1::Scene()
{
}