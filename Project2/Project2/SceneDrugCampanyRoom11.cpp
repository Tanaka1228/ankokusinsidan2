...
//コンストラクタ
CSceneDrugCampanyRoom11::CSceneDrugCampanyRoom11()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom11::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom11* objd = new CObjDrugCampanyRoom11(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM11, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom11::Scene()
{
}