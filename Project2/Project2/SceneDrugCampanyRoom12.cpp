...
//コンストラクタ
CSceneDrugCampanyRoom12::CSceneDrugCampanyRoom12()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom12::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom12* objd = new CObjDrugCampanyRoom12(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM12, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom12::Scene()
{
}