...
//コンストラクタ
CSceneDrugCampanyRoom13::CSceneDrugCampanyRoom13()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom13::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom13* objd = new CObjDrugCampanyRoom13(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM13, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom13::Scene()
{
}