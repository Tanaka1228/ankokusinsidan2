...
//コンストラクタ
CSceneDrugCampanyRoom15::CSceneDrugCampanyRoom15()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom15::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom15* objd = new CObjDrugCampanyRoom15(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM15, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom15::Scene()
{
}