...
//コンストラクタ
CSceneDrugCampanyRoom18::CSceneDrugCampanyRoom18()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom18::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom18* objd = new CObjDrugCampanyRoom18(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM18, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom18::Scene()
{
}