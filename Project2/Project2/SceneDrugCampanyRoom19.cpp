...
//コンストラクタ
CSceneDrugCampanyRoom19::CSceneDrugCampanyRoom19()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom19::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom19* objd = new CObjDrugCampanyRoom19(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM19, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
...
//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom19::Scene()
{
}