...
//コンストラクタ
CSceneDrugCampanyRoom2::CSceneDrugCampanyRoom2()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom2::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom2* objd = new CObjDrugCampanyRoom2(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM2, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom2::Scene()
{
}