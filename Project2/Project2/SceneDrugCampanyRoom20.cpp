...
//コンストラクタ
CSceneDrugCampanyRoom20::CSceneDrugCampanyRoom20()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom20::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom20* objd = new CObjDrugCampanyRoom20(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM20, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
...
//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom20::Scene()
{
}