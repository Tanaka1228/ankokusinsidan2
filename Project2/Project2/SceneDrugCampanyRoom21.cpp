...
//コンストラクタ
CSceneDrugCampanyRoom21::CSceneDrugCampanyRoom21()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom21::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom21* objd = new CObjDrugCampanyRoom21(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM21, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom21::Scene()
{
}