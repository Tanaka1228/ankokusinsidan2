...
//コンストラクタ
CSceneDrugCampanyRoom22::CSceneDrugCampanyRoom22()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom22::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom22* objd = new CObjDrugCampanyRoom22(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM22, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
...
//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom22::Scene()
{
}