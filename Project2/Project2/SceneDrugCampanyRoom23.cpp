...
//コンストラクタ
CSceneDrugCampanyRoom23::CSceneDrugCampanyRoom23()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom23::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom23* objd = new CObjDrugCampanyRoom23(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM23, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
...
//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom23::Scene()
{
}