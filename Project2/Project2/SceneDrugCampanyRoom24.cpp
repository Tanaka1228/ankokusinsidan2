...
//コンストラクタ
CSceneDrugCampanyRoom24::CSceneDrugCampanyRoom24()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom24::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom24* objd = new CObjDrugCampanyRoom24(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM24, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
...
//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom24::Scene()
{
}