...
//コンストラクタ
CSceneDrugCampanyRoom3::CSceneDrugCampanyRoom3()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom3::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom3* objd = new CObjDrugCampanyRoom3(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM3, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom3::Scene()
{
}