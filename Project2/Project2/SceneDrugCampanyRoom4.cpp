...
//コンストラクタ
CSceneDrugCampanyRoom4::CSceneDrugCampanyRoom4()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom4::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom4* objd = new CObjDrugCampanyRoom4(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM4, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom4::Scene()
{
}