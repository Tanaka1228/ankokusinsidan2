...
//コンストラクタ
CSceneDrugCampanyRoom6::CSceneDrugCampanyRoom6()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom6::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom6* objd = new CObjDrugCampanyRoom6(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM6, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom6::Scene()
{
}