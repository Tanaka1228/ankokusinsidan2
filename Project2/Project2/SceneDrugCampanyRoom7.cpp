...
//コンストラクタ
CSceneDrugCampanyRoom7::CSceneDrugCampanyRoom7()
{
}
...
//ゲームステージ初期化メソッド
void CSceneDrugCampanyRoom7::InitScene()
{
	...
	//製薬会社オブジェクト作成
	CObjDrugCampanyRoom7* objd = new CObjDrugCampanyRoom7(); //製薬会社オブジェクト作成
	Objs::InsertObj(objd, OBJ_DRUG_CAMPANY_ROOM7, 3); //作った製薬会社オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneDrugCampanyRoom7::Scene()
{
}