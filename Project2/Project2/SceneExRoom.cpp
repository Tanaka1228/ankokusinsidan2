...
void CSceneExRoom::InitScene()
{
	...
	//病院オブジェクト作成
	CObjExRoom* obje = new CObjExRoom(); //病院オブジェクト作成
	Objs::InsertObj(obje, OBJ_EX_ROOM, 1); //作った病院オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneExRoom::Scene()
{
}
