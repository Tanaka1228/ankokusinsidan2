...
//コンストラクタ
CSceneHospitalroom5::CSceneHospitalroom5()
{
}
...
//ゲームステージ初期化メソッド
void CSceneHospitalroom5::InitScene()
{
	...
	//病院オブジェクト作成
	CObjHospitalroom5* objx = new CObjHospitalroom5(); //病院オブジェクト作成
	Objs::InsertObj(objx, OBJ_XRAY_ROOM, 1); //作った病院オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneHospitalroom5::Scene()
{
}
