...
//コンストラクタ
CSceneInstitute12::CSceneInstitute12()
{
}
...
//ゲームステージ初期化メソッド
void CSceneInstitute12::InitScene()
{
	...
	//研究所オブジェクト作成
	CObjInstitute12* obji = new CObjInstitute12(); //研究所オブジェクト作成
	Objs::InsertObj(obji, OBJ_INSTITUTE12, 3); //作った研究所オブジェクトをオブジェクトマネージャーに登録
}


//ゲームステージ実行中メソッド
void CSceneInstitute12::Scene()
{
}