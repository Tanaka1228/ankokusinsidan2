...
//コンストラクタ
CSceneTemplateRoom::CSceneTemplateRoom()
{
}
...
//ゲームステージ初期化メソッド
void CSceneTemplateRoom::InitScene()
{
	...
	//病院の部屋オブジェクト作成
	CObjTemplateRoom* objh = new CObjTemplateRoom(); //病院部屋オブジェクト作成
	Objs::InsertObj(objh, OBJ_TEMPLATE_ROOM, 1); //作った病院オブジェクトをオブジェクトマネージャーに登録
}
